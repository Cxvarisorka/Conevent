...
import { Calendar, Users, Sparkles, ArrowRight, Eye, EyeOff } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 p-8 xl:p-12 flex-col justify-between relative overflow-hidden">
        {/* Background Decorations */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 -left-24 w-96 h-96 bg-white/10 rounded-full blur-3xl" />
          <div className="absolute top-1/2 -right-24 w-80 h-80 bg-pink-500/20 rounded-full blur-3xl" />
          <div className="absolute -bottom-24 left-1/3 w-72 h-72 bg-indigo-400/20 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 space-y-8">
          ...
          <p className="text-lg text-white/80 max-w-md">
            Join thousands of people discovering amazing events, connecting with organizations, and creating unforgettable experiences.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <span className="text-white text-sm">10k+ Active Users</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
              <Calendar className="w-4 h-4 text-yellow-300" />
              <span className="text-white text-sm">500+ Events Monthly</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
              <Sparkles className="w-4 h-4 text-cyan-300" />
              <span className="text-white text-sm">100+ Organizations</span>
            </div>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 text-base px-4 transition-all duration-200 focus:ring-2 focus:ring-violet-500/20"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 text-base px-4 pr-12 transition-all duration-200 focus:ring-2 focus:ring-violet-500/20"
                      required
                    />
                    <button
                      type="button"
                ...
                <Button
                  type="submit"
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 transition-all duration-200 shadow-lg shadow-violet-500/25"
                  disabled={loading}
                >
                  {loading ? (
